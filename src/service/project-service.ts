...
class ProjectService {
  ...
  public async refetchAllProjects() {
    return this.allProjectsQueryResult.refetch()
  }
  ...
  constructor() {
    ...
    this.refetchAllProjects = this.refetchAllProjects.bind(this)
  ...
  private projectMainQueryResult = provideApolloClient(apolloClient)(() => {
