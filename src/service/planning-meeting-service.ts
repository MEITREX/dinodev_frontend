...
import {
  Animal,
  type DefaultPlanningMeetingFragment, type DefaultSprintFragment,
...
class PlanningMeetingService {
  ...
  public nextIssue = async (issueId: string): Promise<DefaultPlanningMeetingFragment | null> => {
  ...
  public loading = computed(() =>
    this.planningMeetingSubscription.loading.value
  ...
  constructor() {
    ...
    this.planningMeetingSubscription.onError(e => {
      ...
      this.planningMeetingSubscription.restart()
    })
  }
  ...
  private planningMeetingSubscription = provideApolloClient(apolloClient)(() => {
