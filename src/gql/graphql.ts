...
export type SprintStats = {
  ...
  burnDown: Array<Scalars['Int']['output']>;
...
export type DefaultSprintFragment = { __typename?: 'Sprint', id: any, startDate?: any | null, endDate?: any | null, storyPointsPlanned?: number | null, name?: string | null, animal?: Animal | null, number: number, stats: { __typename?: 'SprintStats', totalStoryPoints: number, percentageStoryPointsCompleted: number, percentageStoryPointsInProgress: number, percentageTimeElapsed: number, daysLeft: number, averageStoryPoints: number, successState: SprintSuccessState, burnDown: Array<number> }, placedAssets: Array<{ __typename?: 'PlacedAsset', asset: KnownAsset, x: number, y: number }> } & { ' $fragmentName'?: 'DefaultSprintFragment' };
