...
export enum KnownIcon {
  AchievementCritic = 'ACHIEVEMENT_CRITIC',
  AchievementEarlyBird = 'ACHIEVEMENT_EARLY_BIRD',
  AchievementFirstSteps = 'ACHIEVEMENT_FIRST_STEPS',
  AchievementGettingStarted = 'ACHIEVEMENT_GETTING_STARTED',
  AchievementNightOwl = 'ACHIEVEMENT_NIGHT_OWL',
  AchievementQuickBrownFox = 'ACHIEVEMENT_QUICK_BROWN_FOX',
  AchievementReviewer = 'ACHIEVEMENT_REVIEWER',
  AchievementSocialButterfly = 'ACHIEVEMENT_SOCIAL_BUTTERFLY',
  AchievementSprintChampion = 'ACHIEVEMENT_SPRINT_CHAMPION',
  AchievementSprintLegend = 'ACHIEVEMENT_SPRINT_LEGEND',
  AchievementTaskChampion = 'ACHIEVEMENT_TASK_CHAMPION',
  AchievementTaskLegend = 'ACHIEVEMENT_TASK_LEGEND',
  AchievementTeamPlayer = 'ACHIEVEMENT_TEAM_PLAYER',
  Gropius = 'GROPIUS'
}
...
export type UserInProjectFragment = { __typename?: 'UserInProject', user: { __typename?: 'GlobalUser', id: any, username: string, avatar?: string | null }, roles: Array<{ __typename?: 'ProjectRole', gamifiedName: string, name: string, projectPrivileges: Array<ProjectPrivilege> }>, userStats: { __typename?: 'UserStats', xp: number, level: number, xpToNextLevel: number, totalXp: number } } & { ' $fragmentName'?: 'UserInProjectFragment' };
